- Fixed "Open with Claude Code" context menu not applying the global Extra CLI args setting (https://github.com/nbclaudecodegui/NetbeansClaudeCodeGui/issues/23)
